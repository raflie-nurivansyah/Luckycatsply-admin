...
import {
  ...
  LogOut, ChevronDown, X, Menu, Globe,
} from "lucide-react";

type UserRole = "admin" | "buyer_admin" | "seller_admin" | "marketing_admin";
type Tab = "dashboard" | "buyer" | "seller" | "ship" | "marketing";
...
const NAV_CONFIG: { id: Tab; icon: React.ReactNode; roles: UserRole[] }[] = [
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-2.5">
            ...
            />
            <div>
              <p style={{ color: "#e2e8f0", fontWeight: 800, fontSize: "0.85rem", lineHeight: 1.2, letterSpacing: "-0.01em" }}>
                Luckycatsply
              </p>
        ...
        <div className="px-3 pb-4 relative">
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: "left", minWidth: 0 }}>
              <p style={{ color: "#e2e8f0", fontSize: "0.78rem", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {roleLabel}
              </p>
      ...
      <div className="flex flex-col min-w-0 overflow-hidden" style={{ flex: 1 }}>
        ...
        >
          ...
          <button
            ...
            style={{ background: "#f3f4f6", border: "none", cursor: "pointer", padding: "7px 8px", borderRadius: 8 }}
          >
          ...
          >
            {(["id", "en"] as Lang[]).map((l) => (
              <button
                ...
                style={{
                  padding: "4px 10px",
                  background: lang === l ? "#1e2a4a" : "transparent",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontSize: "0.75rem", color: "#6b7280", fontWeight: 500, display: "none" }} className="sm:inline">
              {roleLabel}
            </span>
          </div>
        </header>
        ...
        <main
          ...
          style={{ padding: "16px", paddingBottom: 32 }}
